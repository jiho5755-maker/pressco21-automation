...
INSERT INTO "new_Employee" ("bankAccount", "bankName", "baseSalary", "breakMinutes", "contractEndDate", "contractType", "createdAt", "departmentId", "dependents", "email", "employeeNo", "employmentInsurance", "flexEndTime", "flexStartTime", "healthInsurance", "id", "industrialAccident", "joinDate", "leaveEndDate", "leaveStartDate", "leaveType", "name", "nationalPension", "phone", "position", "probationEnd", "remoteWorkDays", "replacementForId", "replacementReason", "resignDate", "resignReason", "salaryType", "status", "updatedAt", "weeklyWorkHours", "workEndTime", "workStartTime", "workType") SELECT "bankAccount", "bankName", "baseSalary", "breakMinutes", "contractEndDate", "contractType", "createdAt", "departmentId", "dependents", "email", "employeeNo", "employmentInsurance", "flexEndTime", "flexStartTime", "healthInsurance", "id", "industrialAccident", "joinDate", "leaveEndDate", "leaveStartDate", "leaveType", "name", "nationalPension", "phone", "position", "probationEnd", "remoteWorkDays", "replacementForId", "replacementReason", "resignDate", "resignReason", "salaryType", "status", "updatedAt", "weeklyWorkHours", "workEndTime", "workStartTime", "workType" FROM "Employee";
DROP TABLE "Employee";
