...
// ── 경력증명서 PDF 컴포넌트 ──
export function CareerCertificatePDF({
  employee,
  issueDate,
}: CareerCertificatePDFProps) {
  // 근속 기간 계산 (입사일 ~ 퇴사일)
  const resignDate = employee.resignDate || issueDate;
  const tenure = calculateTenure(employee.joinDate, resignDate);
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableValue}>
              <Text>
                {employee.resignDate
                  ? format(employee.resignDate, "yyyy년 MM월 dd일")
                  : "-"}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableValue}>
              <Text>{employee.resignReason || "일신상의 사유"}</Text>
            </View>
          </View>
        </View>
